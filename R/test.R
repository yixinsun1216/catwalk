...
test_model(list(lm_fits$one), "testing single lm model, one independent variable", 
	est = 'drat')

test_model(list(lm_fits$two), "testing single lm model, two independent variables", 
	est = c('drat', 'cyl'))

test_model(list(lm_fits$three), "testing single lm model, three independent variables", 
	est = c('drat', 'cyl', 'drat:cyl'))

test_model(list(lm_fits$four), "testing single lm model, four independent variables", 
	est = c('drat', 'cyl', 'am', 'drat:cyl'))

test_model(list(lm_fits$five), "testing single lm model, five independent variables", 
...
test_model(list(felm_fits$one), "testing single felm model, one independent variable", 
	est = 'drat')

test_model(list(felm_fits$two), "testing single felm model, two independent variables", 
	est = c('drat', 'cyl'))

test_model(list(felm_fits$three), "testing single felm model, three independent variables", 
	est = c('drat', 'cyl', 'drat:cyl'))

test_model(list(felm_fits$four), "testing single felm model, four independent variables", 
	est = c('drat', 'cyl', 'am', 'drat:cyl'))

test_model(list(felm_fits$five), "testing single felm model, five independent variables", 
	est = c('drat', 'cyl', 'am', 'vs', 'drat:cyl'))
...
test_model(list(model1, model2), "testing dual felm model, two independent variables", 
	est = c('drat', 'cyl'), extra_rows = list("Company" = c("No", "Yes"))) 
